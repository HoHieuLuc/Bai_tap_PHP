...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2021 at 07:19 AM
...
-- Database: `qlbansua`
--
CREATE DATABASE IF NOT EXISTS `qlbansua` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `qlbansua`;
...
('ML', 'Milo', '456 đường XYZ', '0987654321', 'milo@milo.vn'),
...
('kh009', 'Hồ Hiểu Lực', 0, '123 đường ABC', '0123456789', 'luc.hh.60cntt@ntu.edu.vn');
...
('ML0001', 'Sữa milo có đường', 'ML', 'SN', 500, 15000, 'Đường, sữa, cacao', 'Tăng chiều cao, tăng chỉ số IQ', 's_milo.jpg'),
